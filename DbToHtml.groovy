...
j(document).ready(function() {
  ...
  function displayMatchCounts(tables, columns) {
    ...
    j('.match-counts').text(matchCounts);
  }
  // Handle searches
  function search(q) {
